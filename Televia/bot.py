...
class Bot:
    ...
    # send message
    def send_message(self, chat_id, text, receiver_user_id=None, parse_mode=None,reply_markup=None, protect_content=False, message_effect_id=None):
        """
    ...
    def send_photo(self, chat_id, photo, caption=None, receiver_user_id=None, reply_to_message_id=None, parse_mode=None, has_spoiler=False, protect_content=False, message_effect_id=None, reply_markup=None):
        """
    ...
    def send_video(self, chat_id, video, caption=None, receiver_user_id=None, reply_to_message_id=None, parse_mode=None, has_spoiler=False, protect_content=False, message_effect_id=None, reply_markup=None):
        """
    ...
    def send_audio(self, chat_id, audio, caption=None, receiver_user_id=None, reply_to_message_id=None, parse_mode=None, has_spoiler=False, protect_content=False, message_effect_id=None, reply_markup=None):
        """
    ...
    def send_sticker(self, chat_id, sticker, receiver_user_id=None, emoji=None, protect_content=None, message_effect_id=None, reply_markup=None):
        data = {
            "chat_id": chat_id,
            "receiver_user_id": receiver_user_id,
            "emoji": emoji,
        ...
        if isinstance(sticker, str):
            ...
            res = self.request("sendSticker", data=data)
        else:
            files = {"sticker": sticker}
            res = self.request("sendSticker", data=data, files=files)
    ...
    def reply_to(self, message, text, message_id=None,receiver_user_id=None, parse_mode=None,protect_content=False, message_effect_id=None, reply_markup=None):
        """
        reply to message \n
